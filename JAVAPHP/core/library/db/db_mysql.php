...
class db_mysql {
  ...
  function connect() {
    ...
    if ( 0 == $this->Link_ID ) {
      ...
      $this->Link_ID=mysql_pconnect($this->Host, $this->User, $this->Password);
      mysql_query("set session wait_timeout=600");
      //mysql_query("set names 'utf8'",$this->Link_ID);  
      if (!$this->Link_ID) {
        //$this->halt("pconnect($Host, $User, \$Password) failed.");
        $this->halt("Host connect failed.");
        return 0;
      }
      ...
      //处理乱码时代码
      if(strtolower($this->Dbencode)=="gbk"){
          mysql_query("SET NAMES 'gbk'");
      }else if(strtolower($this->Dbencode)=="gb2312"){
          mysql_query("SET NAMES 'gb2312'"); 
      }else if(strtolower($this->Dbencode)=="utf8"||strtolower($this->Dbencode)=="utf-8"){
